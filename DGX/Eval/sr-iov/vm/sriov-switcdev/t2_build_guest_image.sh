#!/usr/bin/env bash
# t2_build_guest_image.sh <1|2> — Generates guest QCOW2 image and cloud-init ISO with Jumbo Frame configuration
...
if [[ -f "${HOME}/.ssh/id_rsa.pub" ]]; then
    ...
    echo "Generating SSH key in ~/.ssh/..."
...
echo "[3/4] Generating Cloud-Init configuration with Jumbo Frames..."
