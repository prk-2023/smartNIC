#!/usr/bin/env bash
# t2_config.sh — Global configuration for vDPA Switchdev Mode
...
VF_NUM=0      # Index of VF used for vDPA management
###MTU="9000"    # Frame size for MTU 9000 Jumbo Frames
MTU="1500"    # Frame size for MTU 1500 default  Frames size
...
# VirtIO Test MAC Addresses (Must match QEMU and vDPA tool)
...
### ---- VM Resources ----
VM_VCPUS=4
VM_MEM="4G"   # Locked memory for DMA memory backing
